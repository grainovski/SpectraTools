...
Expect **1719 collected, 0 failed** (as of v6.0.5). A smaller number that
...
Two of the 1719 may report as **skipped** rather than passed, and that is
...
and still reports all-passed. If the count comes out 30 short (1689 rather
than 1719), that is this, and the fix is to re-run the install step above. Note
