...
Expect **1725 collected, 0 failed** (as of v6.0.7). A smaller number that
...
Two of the 1725 may report as **skipped** rather than passed, and that is
...
and still reports all-passed. If the count comes out 30 short (1695 rather
than 1725), that is this, and the fix is to re-run the install step above. Note
