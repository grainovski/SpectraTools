...
Expect **1775 collected, 0 failed** (as of 6.1.0 development). A smaller
...
Two of the 1775 may report as **skipped** rather than passed, and that is
...
and still reports all-passed. If the count comes out 30 short (1745 rather
than 1775), that is this, and the fix is to re-run the install step above. Note
