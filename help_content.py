...
Spectra</b> (<kbd>Ctrl+N</kbd>) scales every <i>visible</i> spectrum (at
least two must be visible) so they share a common reference value,
useful for visually comparing spectra taken with different live times.</p>
